...
class BaseSettings(BaseModel):
    ...
    # Add a new field for the custom environment toggle
    use_custom_environment: bool = Field(
        default=False, env="USE_CUSTOM_ENVIRONMENT"
    )
    ...
    def __init__(
        ...
        **values: Any,
        ...
        # Uses something other than `self` as the first arg to allow "self" as a settable attribute
        super().__init__(
    ...
    # Populate by the metaclass using the Config class defined above, annotated here to help IDEs only
